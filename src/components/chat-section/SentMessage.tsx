    ...
    <li className="flex mb-3 justify-end ">
      <div className="flex flex-col items-end relative">
        <div className="flex flex-row-reverse items-center">
          <span className="bg-[#0095df] h-10 w-10 text-center p-2 rounded-md mb-1 ml-2 self-end">
            {name.charAt(0)}
          </span>
          <div className="bg-[#8FAADC] text-[#FFFFFF] rounded-2xl p-2 min-h-20 max-w-xs">
            ...
            <span className="text-xs text-[#F2F4F7]">
