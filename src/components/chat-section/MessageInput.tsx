...
export default function MessageInput({
  ...
  return (
    <div className="flex flex-row-reverse bg-[#a5bfff] h-12 items-center rounded-[10px] gap-4">
      <button className="mr-3 text-l  text-[#333333]">
        <Attachment />
      </button>
      <input
        value={message}
        ...
        type="text"
        className="p-1 bg-[#a5bfff] text-[#333333] border-none outline-none text-sm input__message-input inline-block w-full input__search--name text-start text-[13px]"
        placeholder="پیامتان را وارد کنید"
      />
      <button
        onClick={handleSendMessage}
        className="ml-5 text-xl  text-[#333333]"
      >
        <SendMessage />
      </button>
    </div>
